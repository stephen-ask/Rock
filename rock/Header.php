                ...
                <div class="row">
                    <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 col logo_section">
                        <div class="full">
                            <div class="center-desk">
                                <div class="logo">
                                    <a href="<?php echo $site_url;?>"><img src="<?php echo get_template_directory_uri(); ?>/images/logo.jpg" alt="logo" /></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-8 col-lg-8 col-md-10 col-sm-10">
                        <div class="menu-area">
                            <div class="limit-box">
                                <nav class="main-menu">
								<?php wp_nav_menu(array('menu_class' => "menu-area-main"));?>
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2">
                        <form class="search">
                            ...
                            <button><img src="<?php echo get_template_directory_uri(); ?>/images/search_icon.png"></button>
                        </form>
                    </div>
                </div>
            </div>
